...
<body  style="overflow-x:hidden; background:url('images/2.jpg');">
		  <?php
					...
					$uname=$_SESSION["usrid"];
						...
						$result=mysql_query("select * from remaildetail where email_to like '$uname'")or die("not Work");
				
		  $tp=10;
		  $sp=20;
					$result=mysql_query("select * from remaildetail where email_to like '$uname'  order by id  desc  LIMIT  $sp , $tp ")or die("not Work");
			...
			?>			    </div><div class="page"><center><a href="inbox1.php">Privious</a></center></div>
					<?PHP
					if($r<10)
					{
					?>
					<?PHP 
						...
						<div class="page"><center><a href="inbox2.php">Next</a></center></div>
							<?php
					}
							?>
