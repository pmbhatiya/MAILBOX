...
?><body style="overflow-x:hidden; background:url('images/2.jpg');"><?PHP
...
?><img src="<?PHP
	...
	?>
		...
		<?PHP			$rs=mysql_query("insert into remaildetail (pname,email_to,email_from,email_message,email_datetime,email_subject,name) values('$i','$email_to','$uname','$email_message','$cdate','$email_subject','$path')") or die("Not Work");
...
echo "<h1> Message Send Sucessfully </h1>";
}
else
{
